const cards = [
  {
    ...
    body: "Meta creative has a half-life of 9 days. Your best performer is already dying. By the time you brief a replacement, the window is gone.",
    icon: (
  ...
  },
  {
    ...
    body: "Traditional production costs $10K and takes 4 weeks. That's one ad per month, maybe two. It's not enough to test anything.",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    body: "Self-serve tools hand you the same templates as your competitors. There's no brief, no strategy, no signal on what to run next.",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
